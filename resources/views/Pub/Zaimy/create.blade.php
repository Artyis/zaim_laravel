    ...
    <div class="container">
      ...
      <div class="body_wrapper_banner">
        <div class="banner_wrapper_text">
          ...
          <p class="mb-20">{{$page->name}}</p>
          <p class="fw_text">База микрозаймов обновлена : </p>
        </div>
        <?/*php echo get_the_post_thumbnail( get_the_ID(), 'small', array('class' => 'banner_img', 'alt'   => trim(strip_tags( $wp_postmeta->_wp_attachment_image_alt ))) );*/ ?>
      </div>
